...
void g_zmod4xxx_sensor0_quick_setup(void)
{
	...
	// if (FSP_SUCCESS == err)
	// {
	// 	configPRINTF(("ZMOD4410 open sensor instance successful: %d\r\n", err));
	// }
	// else
	// {
	// 	configPRINTF(("ZMOD4410 open sensor instance failed: %d \r\n", err));
	// }
...
void g_zmod4xxx_sensor1_quick_setup(void)
{
	...
	// if (FSP_SUCCESS == err)
	// {
	// 	configPRINTF(("ZMOD4510 open sensor instance successful: %d\r\n", err));
	// }
	// else
	// {
	// 	configPRINTF(("ZMOD4510 open sensor instance successful: %d\r\n", err));
