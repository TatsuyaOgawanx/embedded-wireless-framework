    ...
    switch(sequence)
    {
        case ZMOD4410_DEMO_SEQUENCE_1 :
        {
            ...
            if (FSP_SUCCESS == err)
            {
                ...
                //configPRINTF (("Task zmod4410 measurement Success:%d\r\n",err));
            }
            else
            {
            	//configPRINTF (("Task zmod4410 task delete in seq 1:%d\r\n",err));
            }
...
//        {
            switch (g_i2c_callback_status)
            {
                ...
                case ZMOD4410_DEMO_CALLBACK_STATUS_REPEAT :
                    ...
                    break;
                default :
                	//configPRINTF (("Task zmod4410 task delete in seq 2:%d\r\n",err));
                    break;
            }
        	// }
        ...
        case ZMOD4410_DEMO_SEQUENCE_5 :
        {
            ...
            {
            	//configPRINTF (("Task zmod4410 task delete in seq 5:%d\r\n",err));
            }
        }
        break;
...
//        	{
	...
	// configPRINTF( ( "ZMOD4410-IAQ  : %f \r\n",gs_demo_iaq) );
	// configPRINTF( ( "ZMOD4410-ECO2: %f \r\n",gs_demo_eco2 ) );
	// configPRINTF( ( "ZMOD4410-TVOC: %f \r\n",gs_demo_tvoc ) );
#endif
            }
            else if (FSP_ERR_SENSOR_IN_STABILIZATION == err)
            {
                ...
                sequence = DEMO_SEQUENCE_1;
#endif
                //configPRINTF (("ZMOD4410 in stabilization:%d\r\n",err));

            }
            else
            {
            	//configPRINTF (("Task zmod4410 task delete in seq 7:%d\r\n",err));
            }
        ...
        default :
        {
        	//configPRINTF (("Task zmod4410 task delete in default case:%d\r\n",err));
        }
        break;
    }
}
...
void getZMOD4410Data(st_sensorsZmod4410_t *zmod4410Data)
{
	...
	zmod4410Data->zmod4410Data.ec02 = gs_demo_eco2;
