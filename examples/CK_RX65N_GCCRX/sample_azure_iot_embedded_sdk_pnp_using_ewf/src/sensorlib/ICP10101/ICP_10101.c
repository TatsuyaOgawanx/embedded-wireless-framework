...
void readICPdata()
{
	...
	configPRINTF( ( "ICP10101-Temperature : %f \r\n",gs_icp_temperature ) );
	configPRINTF( ( "ICP10101-Pressure    : %f \r\n",Pressure ) );
#endif
...
void RmComDevice_init(void)
{
    ...
    if(FSP_SUCCESS==err)
    {
    	configPRINTF(("ICP10101 open sensor instance successful: %d \r\n", err));
    }
    else
    {
    	configPRINTF(("ICP10101 open sensor instance failed: %d \r\n", err));
    }
}
