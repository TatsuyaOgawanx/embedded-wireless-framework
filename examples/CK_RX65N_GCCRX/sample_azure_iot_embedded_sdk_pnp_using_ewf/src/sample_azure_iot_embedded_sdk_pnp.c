...
static void sample_telemetry_action(SAMPLE_CONTEXT * context)
{
	...
	static uint16_t telemetry_state = TELEMETRY_STATE_ENVIRONMENTAL;
...
//TODO`s: ADD Telemetry data
    switch (telemetry_state)
    {
#if 0
        case TELEMETRY_STATE_ENVIRONMENTAL:
            /* Send environmental sensor telemetry message.  */
        ...
        case TELEMETRY_STATE_GYROSCOPE:
            /* Send inertial sensor telemetry message.  */
        ...
        case TELEMETRY_STATE_GAS:
            /* Send Gas telemetry message.  */
            ...
            break;
#endif
        case TELEMETRY_STATE_BIO:
            /* Send Biometric sensor telemetry message.  */
